...
async def help(ctx, category=None):
	...
	if category is None:
		...
		embed.set_author(name="THE丶J U И G Ł Σ Σ 丶βHΩΩT 𝐒𝐄𝐋𝐅𝐁𝐎𝐓|𝙋𝙍𝙀𝙁𝙄𝙓:" +
		                 str(Exeter.command_prefix),
		                 icon_url=Exeter.user.avatar_url)
		embed.set_thumbnail(url=Exeter.user.avatar_url)
		embed.set_image(
		    url=
		    "https://cdn.discordapp.com/attachments/847729769722413106/848787394831843338/standard.gif"
		)
		...
		embed.set_image(
		    url=
		    "https://cdn.discordapp.com/attachments/837004234200973392/838270835214647336/standard.gif"
		)
